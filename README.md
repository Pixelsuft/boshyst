...
Automatic start/end of the recording can be configured with `render_start`, `render_count`/`render_end` (not recommended). <br />
...
Run `audio_merge.bat` script created in the game folder to join all sounds in a single output (it requires FFmpeg). <br />
